...
public class TransactionIncomePendingHandler extends TransactionIncomeHandler{
    ...
    public void handle(TransactionEvent event) {
        try {
            ...
            Notification notification = notificationMapper.transactionIncomePendingToNotification(event, user);

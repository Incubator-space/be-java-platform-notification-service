...
public class TransactionOutcomeCompletedHandler extends TransactionOutcomeHandler {
    ...
    public void handle(TransactionEvent event) {
        try {
            ...
            Notification notification = notificationMapper.transactionOutcomeCompletedToNotification(event, user);

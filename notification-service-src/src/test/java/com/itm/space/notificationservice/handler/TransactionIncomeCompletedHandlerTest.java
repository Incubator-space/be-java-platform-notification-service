...
import com.itm.space.notificationservice.kafka.handler.impl.TransactionIncomeCompletedHandler;
import org.junit.jupiter.api.Assertions;
import org.junit.jupiter.api.DisplayName;
import org.junit.jupiter.api.Test;
import org.springframework.beans.factory.annotation.Autowired;

     class TransactionIncomeCompletedHandlerTest extends BaseIntegrationTest {
        @Autowired
        private TransactionIncomeCompletedHandler transactionIncomeCompletedHandler;

        private static final String TRANSACTION_EVENT_JSON_PATH ="json/handler/TransactionIncomeCompletedHandlerTest/TransactionIncomeCompletedHandlerTest";

        @Test
        @DisplayName("true if type == INCOME and status == COMPLETED")
        void shouldHandleWhenEventStatusIsCompleted() {
            ...
            boolean result = transactionIncomeCompletedHandler.isHandle(event);

            Assertions.assertTrue(result);
        }

        @Test
        @DisplayName("Создание нотификации \"Оплата проведена\" и сумма amount в копейках с корректными данными")
        ...
        void shouldCreateNotificationWithCorrectData() {
            ...
            transactionIncomeCompletedHandler.handle(event);
        }
